...
export default async function handler(req,res){
  ...
  }catch(e){console.error(e);return res.status(500).send(page('<section class="panel warn"><h2>Ошибка экзамена</h2><p>Не удалось начать экзамен. Попробуйте ещё раз.</p><a class="btn secondary" href="/">Главный экран</a></section>'))}
}
